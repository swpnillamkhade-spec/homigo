// JSX - REACT COMPONENTS FOR HOMIGO SERVICES
// Save this as: App.jsx or components.jsx
...
/**
 * BookingForm Component - Service booking form
 */
const BookingForm = ({ bookingForm, onFormChange, onSubmit, onCancel }) => {
    return (
...
/**
 * ServiceGrid Component - Grid of services
 */
...
/**
 * BookingConfirmation Component - Confirmation screen
 */
const BookingConfirmation = ({ orderID, bookingForm, onBackToServices }) => {
    return (
                        ...
                        {selectedSubcategory ? (
                            <div className="bg-white rounded-2xl shadow-lg p-8">
                                ...
                                <button
                                    ...
                                    className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-3 px-6 rounded-lg font-bold hover:shadow-lg transition"
                                >
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-8">
                                ...
                                <p className="text-slate-600 text-lg">{selectedCategory.description}</p>
                            </div>
                        )}
                    </div>
                ) : (
